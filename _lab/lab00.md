...
Follow the appropriate links to install Python for your computer. If you're using a computer in Phelps, then these computers should already have Python installed.
